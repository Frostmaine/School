...
<html>
    ...
    <body>
        ...
        <section class = "content_container" id = "small_container">
            ...
            <form id="login_form" action="LoginChoiceServlet" method = "POST">              
                <div >
                    <img id="huskyIcon" src="images/husky.png">
                </div>
                <div id = "login_text_container">

                    <input type ="submit" name = "login" value="BU Login" class="btn"/>
                    <input type ="submit" name = "login" value="Application Login" class="btn"/>
                </form>
                <br>
                <br>
