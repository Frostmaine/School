...
public class EmailUtility {
     ...
     try {
      ...
      //Set the smtp host to the host provided in the general properties file
           // props.put("mail.smtp.host", SMTP_HOST_NAME);
            props.put("mail.smtp.host", "out.bloomu.edu");
 ...
 //           mailSession.setDebug(true); // Gives detailed output
            ...
            else message.setFrom(new InternetAddress(SMTP_USER_ACCOUNT));
            System.out.println("SMTP_USER_ACCOUNT "+SMTP_USER_ACCOUNT);
        ...
        //   Debug.println("Adding #"+toAddress+"#");
           ...
           WebErrorLogger.log(Level.WARNING, 
             "Could not send mail in email(Collection<String> recipients, Collection<String> "+
                     "ccrecipients, String mailMessage, String subject)", ex);
        }
    }
