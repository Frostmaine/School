...
public class ControlServlet extends HttpServlet {
          ...
          // Update the information in the user table for this user  
            ...
            if(action.trim().equalsIgnoreCase("resetpassword")){
              ...
              //     log("user id was "+ request.getParameter("UID") );
                   ...
                   WebErrorLogger.log(Level.SEVERE,user.getLoginName() +" DB token="+request.getParameter("token")+" password token="+
   ...
   //          response.sendRedirect(request.getContextPath() + "/html/indexDirect.html");
            ...
            //    .getRequestDispatcher("/html/javascriptDisabled.html") 
               ...
               .forward(request, response);
                ...
                return;    // return is needed in case other actions are needed
             }
