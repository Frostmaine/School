...
/**
    ...
    public static SecretKey generateTripleDESKey() {
        ...
        try {
            ...
            WebErrorLogger.log(Level.SEVERE, "NoSuchAlgorithmException is thrown while "
                    + "trying to generate a secret key for DESede.", ex);
        }
        if (keygenerator == null) {
            return null;
        } else {
    ...
    private static byte[] base64Decode(String str) {
       //return  new sun.misc.BASE64Decoder().decodeBuffer(str); -- could throw IOException
    ...
    public static void main(String[] args) {
        ...
        File file = new File(Paths.HOMEDIRECTORY+"/Web Pages/WEB-INF/DoNotDeleteFile");
        SecretKey key;
