...
public class CreateTables {
    ...
    public static void main(String []args) throws SQLException{
      ...
      //  Connection connection = MYSQL_Helper.getConnection();
        ...
        statement.execute("DROP TABLE authorISBN;"); //Will error if table does not exist 
        statement.execute("DROP TABLE titles;"); 
    ...
    statement.execute("CREATE TABLE authorISBN (" +
    ...
    statement.execute("INSERT INTO authors (firstName, lastName)" +
        "VALUES " +
        "   ('Paul','Deitel'), " +
        "   ('Harvey','Deitel')," +
        "   ('Abbey','Deitel'), " +
    ...
    statement.execute("INSERT INTO titles (isbn,title,editionNumber,copyright)" +
        "VALUES" +
    ...
    statement.execute("INSERT INTO authorISBN (authorID,isbn)" +
        "VALUES " +
        "   (1,'0132151006')," +
        "   (2,'0132151006')," +
        "   (3,'0132151006')," +
